...
var useModel = function useModel(model) {
  ...
  var localModel = useRef(emptyObj);

  var _useState = useState(false),
      setState = _useState[1];

  var onEffect = useRef(noop);
  useMemo(function () {
